...
Once you have a file you want to download you can just run `filesystem download <some_file>`. This will download that file to your working directory. The same way you can upload files using `filesystem upload`.
